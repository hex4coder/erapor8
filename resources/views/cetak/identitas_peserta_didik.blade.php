...
@section('content')
    ...
    <table width="100%" id="alamat">
        ...
        <tr>
            ...
            <td style="width: 1%;">:</td>
            <td style="width: 58%">{{ $get_siswa->peserta_didik->agama ? $get_siswa->peserta_didik->agama->nama : '' }}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 1%;">:</td>
            <td style="width: 58%">{{ ucwords(strtolower($get_siswa->peserta_didik->alamat)) }} RT
                {{ $get_siswa->peserta_didik->rt }} / RW {{ $get_siswa->peserta_didik->rw }},
                {{ ucwords(strtolower($get_siswa->peserta_didik->desa_kelurahan)) }}
                {{ ucwords(strtolower($get_siswa->peserta_didik->kecamatan)) }}
                {{ $get_siswa->peserta_didik->wilayah->parrentRecursive->parrentRecursive->nama }}
                {{ $get_siswa->peserta_didik->kode_pos }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 1%;">:</td>
            <td style="width: 58%">
                {{ $get_siswa->peserta_didik->sekolah_asal ? $get_siswa->peserta_didik->sekolah_asal : '-' }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 1%;">:</td>
            <td style="width: 58%">
                {{ $get_siswa->peserta_didik->diterima_kelas ? $get_siswa->peserta_didik->diterima_kelas : '-' }}</td>
        </tr>
        <tr>
            <td style="width: 5%;">&nbsp;</td>
        ...
        <tr>
            ...
            <td style="width: 35%;padding:5px;">Nomor Telepon Rumah</td>
            <td style="width: 1%;">:</td>
            <td style="width: 58%">{{ $get_siswa->peserta_didik->no_telp ? $get_siswa->peserta_didik->no_telp : '-' }}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 1%;">:</td>
            <td style="width: 58%">
                {{ $get_siswa->peserta_didik->nama_wali ? $get_siswa->peserta_didik->nama_wali : '-' }}</td>
        </tr>
        <tr>
            ...
            <td style="width: 1%;">:</td>
            <td style="width: 58%">
                {{ $get_siswa->peserta_didik->nama_wali ? $get_siswa->peserta_didik->alamat_wali : '-' }}</td>
        </tr>
        <tr>
            <td style="width: 5%;">&nbsp;</td>
            <td style="width: 35%;padding:5px;">Nomor Telepon Rumah</td>
            <td style="width: 1%;">:</td>
            <td style="width: 58%">
                {{ $get_siswa->peserta_didik->nama_wali ? $get_siswa->peserta_didik->telp_wali : '-' }}</td>
        </tr>
        <tr>
            ...
            <td style="width: 1%;">:</td>
            <td style="width: 58%">
                {{ $get_siswa->peserta_didik->nama_wali ? $get_siswa->peserta_didik->pekerjaan_wali->nama : '-' }}</td>
        </tr>
    </table>
